 ...
 *   Gacha amount 200           # Set Gacha Amount 200
 *
 *
 * Item Note:
 *   <gachaImage:image>        # Gacha image file name. Please image put in "img/pictures/" folder.
 ...
 *   Gacha amount 200           # ガチャを引くのに必要なGを200に設定します。
 *
 *
 * Item Note:
 *   <gachaImage:image>        # ガチャアイテムの画像を指定します。画像はimg/pictures/フォルダ内に入れてください。
...
(function () {
    ...
    Window_GachaCommand.prototype.canGacha = function () {
        return (this.isCostTypeVariable() ? $gameVariables.value(variable) : $gameParty.gold()) >= $gameSystem.gachaAmount() &&
            !!this._lotIsValid;
    };
    ...
    Window_GachaGet.prototype.refresh = function() {
        ...
        if (!item || !item.meta.gachaImage) {
            ...
            var bitmap;
            bitmap = ImageManager.loadBitmap("img/pictures/", this._item.meta.gachaImage);
